...
public class SignUpPage {
    ...
    @Step("registration of a new student авторазиция пользователя")
    ...
    @Step("Click on the Button show Password Кликнуть на иконку Показать пароль")
    ...
    @Step("Click the button Sign Up in the Registry Form Нажатие кнопки Sign In в форме регистрации")
